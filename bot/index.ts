...
const helpCommand = {
  ...
  async execute(interaction: ChatInputCommandInteraction) {
    const embed = new EmbedBuilder()
      ...
      .setColor(0x5865F2)
      .addFields(
        { name: "/stock", value: "View available member stock", inline: true },
        { name: "/buy", value: "Buy members for your server", inline: true },
        { name: "/check", value: "Check server information", inline: true },
        { name: "/ticket", value: "Open a support ticket", inline: true },
        { name: "/join", value: "[Admin] Force join members to server", inline: true },
  ...
  data: new SlashCommandBuilder()
    ...
    .addStringOption(opt =>
      opt.setName("type")
        ...
        .setRequired(true)
        .addChoices(
          { name: "Buy Members", value: "buy_members" },
          { name: "Buy Coins", value: "buy_coins" },
